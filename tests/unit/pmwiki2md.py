...
from lib.pmwiki2md import Content, Conversions
class ConversionTests(unittest.TestCase):
	...
	def test_Pmwiki2MdItalicConversion(self):
		from lib.pmwiki2md import Pmwiki2MdItalicConversion as Conversion
	...
	def test_Pmwiki2MdSmallConversion(self):
		from lib.pmwiki2md import Conversions, Pmwiki2MdSmallBeginConversion, Pmwiki2MdSmallEndConversion
		original = Content("Cucumbers [-might-] be tomatoes.")
		shouldLookLike = ["Cucumbers ", "<sub>", "might", "</sub>", " be tomatoes."]
	...
	def test_Pmwiki2MdBigConversion(self):
		from lib.pmwiki2md import Conversions, Pmwiki2MdBigBeginConversion, Pmwiki2MdBigEndConversion
		original = Content("Cucumbers [+might+] be tomatoes.")
	...
	def test_Pmwiki2MdItalicBoldConversion(self):
		from lib.pmwiki2md import Pmwiki2MdItalicBoldConversion as Conversion
		original = Content("Cucumbers '''''might''''' be tomatoes.")
		shouldLookLike = ["Cucumbers ", "**_", "might", "**_", " be tomatoes."]
		self.compareConverted(original, shouldLookLike, Conversion)
		
	def test_Pmwiki2MdTitle1Conversion(self):
		from lib.pmwiki2md import Pmwiki2MdTitle1Conversion as Conversion
		original = Content("\n!Cucumbers might be tomatoes.")
		shouldLookLike = ["", "\n# ", "Cucumbers might be tomatoes."]
		self.compareConverted(original, shouldLookLike, Conversion)
		
	def test_Pmwiki2MdTitle2Conversion(self):
		from lib.pmwiki2md import Pmwiki2MdTitle2Conversion as Conversion
		original = Content("\n!!Cucumbers might be tomatoes.")
		shouldLookLike = ["", "\n## ", "Cucumbers might be tomatoes."]
		self.compareConverted(original, shouldLookLike, Conversion)
	...
	def test_Pmwiki2MdSubscriptConversion(self):
		from lib.pmwiki2md import Pmwiki2MdSubscriptConversion as Conversion
